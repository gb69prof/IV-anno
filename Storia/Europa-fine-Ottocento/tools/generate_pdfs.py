...
DEEP=colors.HexColor('#243b4a'); ACCENT=colors.HexColor('#973f45'); GOLD=colors.HexColor('#c69b4b'); PAPER=colors.HexColor('#fffaf1'); INK=colors.HexColor('#252a2d'); MUTED=colors.HexColor('#687075')
...
def maps_pdf():
    ...
    with tempfile.TemporaryDirectory(prefix='europa-mappe-') as temp:
        ...
        doc.build(story)
def synthesis_pdf():
    doc=Doc(OUTA/'sintesi-generale.pdf','Sintesi generale');story=cover('Sintesi generale','Risultati, costi e problemi aperti','1871-1905',D['meta']['question'])

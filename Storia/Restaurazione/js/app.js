  ...
  function renderMaps() {
    ...
    app.innerHTML = `<div class="app-container">
      ...
      <div class="map-grid">
        ...
        ${mapCard('4. L’Europa nel 1815', 'La carta mostra Stati cuscinetto, ingrandimenti e nuove confederazioni. Aprila per osservare i dettagli.', mapImage('assets/img/maps/europa-1815.png','Carta politica dell’Europa nel 1815','Europa nel 1815'), true)}
        ${mapCard('5. L’Italia restaurata', 'La penisola torna frammentata e cade sotto una forte, ma non uniforme, egemonia austriaca.', mapImage('assets/img/maps/italia-1815.png','Carta politica dell’Italia nel 1815','Italia nel 1815'), true)}

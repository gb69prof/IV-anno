# Zante interiore — Un viaggio in Foscolo

PWA didattica interattiva dedicata a Ugo Foscolo: dalla natura meccanicista alle
fratture, alle illusioni, alle opere e all'epilogo di *A Zacinto*.
...
Per creare la versione statica destinata a GitHub Pages:

```bash
npm run build -- --config vite.github.config.ts
```
